...
/* 
 * CROEvolutionState.java
 * 
 * Created: Tue Aug 10 22:14:46 1999
 * By: Sean Luke
 * Modified by: ebermejo
 */

/**
 * A CROEvolutionState is an EvolutionState which extendes ecj.simple form
 * of generational evolution, introducing a change in the generation calculations
 *
...
public class CROEvolutionState extends EvolutionState
    {
    ...
    public void startFresh() 
        ...
        if (numEvaluations > UNDEFINED)
            ...
            output.message("Generations will be " + numGenerations+" (aprox.)");
            } else {
            	output.error("Number of Evaluations is undefined");
            }
