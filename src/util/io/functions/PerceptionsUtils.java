...
public class PerceptionsUtils implements StatisticsUtils, AttributedStatisticsUtils{

	@Override
	public double[][][] getValues(Statistics stats) {
		return stats.getPerceptionsByAttByBrandByStep();
	}

	@Override
	public double[][][] getValuesBySegment(Statistics stats, int index) {
		return stats.getPerceptionsBySegByAttByBrandByStep()[index];
	}
