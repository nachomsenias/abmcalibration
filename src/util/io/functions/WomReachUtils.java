...
public class WomReachUtils implements StatisticsUtils, UnAttributedStatisticsUtils{

	@Override
	public double[][] getValues(Statistics stats) {
		return stats.getWomReachByBrandByStep();
	}

	@Override
	public double[][] getValuesBySegment(Statistics stats, int index) {
		return stats.getWomReachBySegmentByBrandByStep()[index];
	}
