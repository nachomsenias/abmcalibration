...
public class WomVolumenByBrandUtils implements StatisticsUtils, UnAttributedStatisticsUtils{

	@Override
	public double[][] getValues(Statistics stats) {
		return stats.getWomVolumenByBrandByStep();
	}

	@Override
	public double[][] getValuesBySegment(Statistics stats, int index) {
		return stats.getWomVolumenBySegByBrandByStep()[index];
	}
